...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                ...
                <a href="<?php echo e(route('main')); ?>" class="nav-link">Main</a>
   ...
   <?php echo $__env->make("admin.inc.left", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home/brightbr/public_html/resources/views/admin/main.blade.php ENDPATH**/ ?>