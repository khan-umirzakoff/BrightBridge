...
?>
    ...
    <article class="blog_item">
        <div class="blog_item_img">
            ...
            <a href="<?php echo e(route('single-blog', ['id' => $item->id])); ?>" class="blog_item_date">
                <h3><?=$day?></h3>
                <p><?=$month?></p>
            </a>
        </div>
                   ...
                   <aside class="single_sidebar_widget popular_post_widget">
                    ...
                    <?php $__currentLoopData = $recentPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="media post_item">
                            <!-- Correct image path -->
                            <img src="<?php echo e(asset($post->img)); ?>" alt="post" style="width: 50px;height: 50px;object-fit: contain;">
...
<?php echo $__env->make("main2.main2", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/brightbr/public_html/resources/views/pages/newscategory.blade.php ENDPATH**/ ?>