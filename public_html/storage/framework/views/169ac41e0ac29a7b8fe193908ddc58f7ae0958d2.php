                    ...
                    <div class="job_lists m-0">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="single_jobs white-bg d-flex justify-content-between">
                                        <div class="jobs_left d-flex align-items-center">
                                            <div class="thumb">
                                                <img src="../<?php echo e($item->img); ?>" style="width: 50px;height: 50px;object-fit: cover;">
                                            </div>
                                            <div class="jobs_conetent">
                                                <a href="<?php echo e(route('job_details',['id'=>$item->id])); ?>"><h4><?php echo e($item->title); ?></h4></a>
                                                <div class="links_locat d-flex align-items-center">
                                                   
                                                    <div class="" style="background-color: ; width: 150px; padding-right: 10px;margin-left: 10px;padding-top: 5px;height: 40px;">
                                                        <p> <i class="fa fa-briefcase"></i> <font size="2">  <?php echo e($item->company); ?></font></p>
                                                    </div>


                                                   <div class=""  style="background-color: ; width: 150px; padding-right: 10px;margin-left: 10px;padding-top: 5px;height: 40px;">
                                                        <p> <i class="fa fa-map-marker"></i> <font size="2">  <?php echo e($item->location); ?></font></p>
                                                    </div>
                                                    <div class="" style="background-color: ; width: 150px; padding-right: 10px;margin-left: 10px;padding-top: 5px;height: 40px;">
                                                        <p> <i class="fa fa-clock-o"></i><font size="2">  <?php echo e($item->type); ?></font></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="jobs_right">
                                            ...
                                            <div class="date">
                                                <p>Date line: <?php echo e($item->date); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="pagination_wrap">
                            <ul>
                                ...
                                <?php else: ?>
                                    <li><a href="<?php echo e($jobs->previousPageUrl()); ?>"> <i class="ti-angle-left"></i> </a></li>
                                <?php endif; ?>
                                ...
                                <?php $__currentLoopData = $jobs->getUrlRange(1, $jobs->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="<?php echo e($page == $jobs->currentPage() ? 'active' : ''); ?>">
                                        <a href="<?php echo e($url); ?>"><span><?php echo e($page); ?></span></a>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                <!-- Next Page Link -->
                                <?php if($jobs->hasMorePages()): ?>
                                    <li><a href="<?php echo e($jobs->nextPageUrl()); ?>"> <i class="ti-angle-right"></i> </a></li>
                                <?php else: ?>
...
<?php echo $__env->make("main2.main2", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/brightbr/public_html/resources/views/pages/category.blade.php ENDPATH**/ ?>