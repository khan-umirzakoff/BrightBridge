            ...
            <div class="contact-form mx-auto" style="width: 50%; background-color: #f8f9fa; padding: 20px; border-radius: 10px;">
                <form action="" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="title" value="<?php echo e($job->title ?? ''); ?>" required>
                    </div>

                    <!-- Location -->
                    <div class="form-group mb-3">
                        <label class="font-weight-bold">Location</label>
                        <input type="text" class="form-control" name="location" value="<?php echo e($job->location ?? ''); ?>" required>
                    </div>

                    <!-- Job Type -->
                    <div class="form-group mb-3">
                        <label class="font-weight-bold">Job Type</label>
                        <input type="text" class="form-control" name="type" value="<?php echo e($job->type ?? ''); ?>" required>
                    </div>

                    <!-- Job Info -->
                    <div class="form-group mb-3">
                        <label class="font-weight-bold">Job Info</label>
                        <textarea class="form-control" name="info" rows="4"><?php echo e($job->info ?? ''); ?></textarea>
                    </div>

                    <!-- Responsibilities -->
                    <div class="form-group mb-3">
                        <label class="font-weight-bold">Responsibilities</label>
                        <textarea class="form-control" name="responses" rows="4"><?php echo e($job->responses ?? ''); ?></textarea>
                    </div>

                    <!-- Qualifications -->
                    <div class="form-group mb-3">
                        <label class="font-weight-bold">Qualifications</label>
                        <textarea class="form-control" name="quals" rows="4"><?php echo e($job->quals ?? ''); ?></textarea>
                    </div>

                    <!-- Benefits -->
                    <div class="form-group mb-3">
                        <label class="font-weight-bold">Benefits</label>
                        <textarea class="form-control" name="benefits" rows="4"><?php echo e($job->benefits ?? ''); ?></textarea>
                    </div>
...
<div class="single-field">
    ...
    <input type="radio" id="fixed_salary" name="salary_option" value="fixed" 
        <?php echo e(is_numeric(str_replace(' ', '', $job->salary)) ? 'checked' : ''); ?> required>
    <label for="fixed_salary">Fixed Salary</label>

    <input type="radio" id="negotiable_salary" name="salary_option" value="negotiable" 
        <?php echo e($job->salary === "Negotiable" ? 'checked' : ''); ?> required>
    <label for="negotiable_salary">Negotiable</label>
</div>
<br>

<!-- Salary Input (Initially Hidden) -->
<div id="salary_input_div" class="control-group" style="display: <?php echo e(is_numeric(str_replace(' ', '', $job->salary)) ? 'block' : 'none'); ?>;">
    <label for="salary_input">Enter Salary</label>
    <input type="text" class="form-control" id="salary_input" name="salary"
        value="<?php echo e(is_numeric(str_replace(' ', '', $job->salary)) ? number_format(str_replace(' ', '', $job->salary), 0, '.', ' ') : ''); ?>"
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control" name="cat_id" required>
                            <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cat->id); ?>" <?php echo e($job->cat_id == $cat->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make("main2.main2", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/brightbr/public_html/resources/views/pages/jobedit2.blade.php ENDPATH**/ ?>