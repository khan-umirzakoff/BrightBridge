<?php $__env->startSection("content"); ?>
    ...
    <div class="submit_btn">
        <a class="boxed-btn3" style="width: 100%; height: 50px;" href="<?php echo e(route('myapplications',['id'=>$userid])); ?>">You have already applied</a>
    </div>
<?php else: ?>
  

                                    <div class="submit_btn">
                                        <a class="boxed-btn3" style="width: 100%;height: 50px" href="<?php echo e(route('apply',['id'=>$job[0]->id])); ?>">Apply</a>
...
<?php endif; ?>
                     <?php  } else{?>
                                     ...
                                     <div class="submit_btn">
                                        <a class="boxed-btn3" style="width: 100%;height: 50px" href="<?php echo e(route('login')); ?>">Log in to Apply</a>
                                    </div>
...
<?php echo $__env->make("main2.main2", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/brightbr/public_html/resources/views/pages/job_details.blade.php ENDPATH**/ ?>