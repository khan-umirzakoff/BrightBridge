            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="bradcam_text">
                        <h3><?php echo e($countjobs); ?>+ Jobs Available</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <form id="filter-form">
                    ...
                    <div class="col-lg-12">
                        <div class="single_field">
                            <select id="job_type" class="wide">
                                ...
                                <?php $__currentLoopData = ['Full-time', 'Part-time', 'Internship', 'Freelance', 'Volunteering', 'Full-time and Part-time']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-lg-9">
                    ...
                    <div id="filtered-jobs" class="job_lists m-0">
                        <div class="row">
                            <?php echo $__env->make('pages.filter', ['jobs' => $jobs], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make("main2.main", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/brightbr/public_html/resources/views/pages/jobs.blade.php ENDPATH**/ ?>